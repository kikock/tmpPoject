 ...
 **/
@Data
@TableName(value = "mts_personnel_dept", autoResultMap = true)
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(description = "单位总评规则")
public class PersonnelDept implements Serializable {
     ...
     * 规则类型
     */
    @Excel(name = "规则类型", width = 15, dicCode = "evaluation_grade")
     ...
     * 适用条件
     */
    @Excel(name = "适用条件(未使用)", width = 15)
    @ApiModelProperty(value = "适用条件(未使用)")
    @ExcelIgnore
